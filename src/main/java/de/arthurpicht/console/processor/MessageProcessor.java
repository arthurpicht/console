...
public class MessageProcessor {
    ...
    public void process(Message message) {
        ...
        if (!consoleConfiguration.isMuteMessageChannelling()) {
            for (MessageChannel messageChannel : this.consoleConfiguration.getMessageChannelList()) {
                messageChannel.process(message);
            }
        }
    }
...
//        if (this.consoleConfiguration.getMessageChannelList().isEmpty()) return;
...
//        for (LoggerDelegatorConfig loggerDelegatorConfig : this.consoleConfiguration.getMessageChannelList()) {
